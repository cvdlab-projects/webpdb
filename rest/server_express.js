...
app.get('/', function(req, res){
  ...
  res.write('<div align=left><h1>Search a protein by ID:</h1></div>');
  res.write('<form enctype="application/x-www-form-urlencoded" action="/retrieveById" method="get">');
  res.write('<div align=left>Name: <input type="text" name="proteinID" value="Protein_ID" /><br /></div>');
  res.write('<div align=left><input type="submit" /></div>');
  res.write('</form>');
  res.write('<div align=right><h1>Search a protein by Name:</h1></div>');
  res.write('<form enctype="application/x-www-form-urlencoded" action="/retrieveByName" method="get">');
  res.write('<div align=right>Name: <input type="text" name="proteinName" value="Protein_Name" /><br /></div>');
  res.write('<div align=right><input type="submit" /></div>');
  res.write('</form></html>');
  res.end();
